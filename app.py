...
def index():
    ...
    last_updated_url = requests.get('https://raw.githubusercontent.com/evanesoteric/nordvpn-geolocator/main/last_updated.txt')
    last_updated = last_updated_url.text
    if last_updated_url.status_code == 404:
        last_updated = "Error loading"
    vpns_url = requests.get('https://raw.githubusercontent.com/evanesoteric/nordvpn-geolocator/main/vpns.json')
